...
const directionalLightM = (gui, lightGroup, helperGroup, x, y, z, intensity, color, lightGui) => {
    ...
    directionalLight.shadow.bias = -0.0094; 
    // gui.add(directionalLight.shadow,'bias',-1,1,0.0001) 
    lightGroup.add(directionalLight);
    lightGui && directionalLightGUI(gui, directionalLight, 'directionalLight');
    const directionalLightCameraHelper = new THREE.CameraHelper(directionalLight.shadow.camera);
    helperGroup.add(directionalLightCameraHelper);
}
